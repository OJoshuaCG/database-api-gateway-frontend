...
/**
 * Catálogo COMPLETO de blueprints, como contenido de la pestaña «Blueprints».
 *
 * «Completo» es la característica, no un detalle: lista todos los blueprints del gateway, tengan
 * proyecto o no. La pestaña «Proyectos» los muestra agrupados, y un blueprint puede pertenecer a
 * varios proyectos o a ninguno — así que sin esta vista los que no están en ningún proyecto no
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm text-muted-foreground">
          Todos los blueprints del gateway, tengan proyecto o no.
        </p>
